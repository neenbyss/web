...
export const PlansProduction = () => {
  return (
    <div className='container-screen-2xl py-20'>
      <h3 className='mb-1.5 text-center text-5xl'> Planes en Producción </h3>
      <p className='pt-1.5 text-center text-lg'>
        {' '}
        Planes ideales para servidores ya en funcionamiento{' '}
      </p>
      <div className='mx-auto flex w-full max-w-4xl shrink-0 justify-center gap-4 py-20'>
