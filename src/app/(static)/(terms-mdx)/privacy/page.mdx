...
Medimos el uso del sitio únicamente con Google Analytics 4 (GA4); no utilizamos publicidad, remarketing ni píxeles de terceros. Lo que se recopila: páginas visitadas (solo la ruta, sin parámetros de la URL), eventos de interacción (contacto, contenido y preguntas frecuentes), profundidad de desplazamiento y tu elección de consentimiento, que se guarda en tu navegador. Al entrar, la medición está desactivada por defecto y solo se activa si aceptas el aviso de cookies; si la rechazas, el almacenamiento de analítica permanece desactivado y no se registra ninguna medición. También puedes configurar tu navegador para rechazar todas las cookies o para indicarte cuándo se envía una cookie.
